defmodule NovyNative do
  ...
  import NovyWeb, only: [verified_routes: 0]
  ...
  def live_view() do
    quote do
      use LiveViewNative.LiveView,
        ...
        layouts: [
          swiftui: {NovyWeb.Layouts.SwiftUI, :app}
        ],
  ...
  defp helpers(format) do
    ...
    core_component_module = Module.concat([NovyWeb, CoreComponents, plugin.module_suffix])
