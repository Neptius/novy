defmodule NovyWeb.Router do
  ...
  if Application.compile_env(:novy, :dev_routes) do
  ...
  scope "/", NovyWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{NovyWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", NovyWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{NovyWeb.UserAuth, :ensure_authenticated}] do
